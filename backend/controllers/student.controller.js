...
exports.getStudentLookup = catchAsync(async (req, res) => {
  try {
    const institute_id = req.user.institute_id;
 ...
 * @access Admin only
 */
exports.bulkDeleteStudents = catchAsync(async (req, res) => {
  let transaction;
  try {
 ...
 * @access Admin
 */
exports.resendStudentCredentials = catchAsync(async (req, res) => {
  try {
    const { id } = req.params;
    const institute_id = req.user.institute_id;
 ...
 * @access Admin
 */
exports.getStudentCredentials = catchAsync(async (req, res) => {
  try {
    const { student_ids } = req.body;
    const institute_id = req.user.institute_id;
 ...
 */
exports.clearUnreadAssignments = catchAsync(async (req, res) => {
  try {
 ...
 * Clear unread notes
 */
exports.clearUnreadNotes = catchAsync(async (req, res) => {
  try {
    const { User } = require("../models");
 ...
 */
exports.clearUnreadChats = catchAsync(async (req, res) => {
  try {
